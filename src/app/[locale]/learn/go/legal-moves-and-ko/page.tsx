...
export default function LegalMovesAndKoPage() {
  return (
    <Container className="py-10">
      ...
      <div className="grid items-start gap-x-6 gap-y-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,3fr)]">
        <LessonOutline items={legalMovesAndKoOutline} />
        <div className="min-w-0">
          <LegalMovesAndKoLesson />
          <LessonNavigation
            previousLesson={GO_LESSONS[1]}
            nextLesson={GO_LESSONS[3]}
          />
        </div>
      </div>
    </Container>
