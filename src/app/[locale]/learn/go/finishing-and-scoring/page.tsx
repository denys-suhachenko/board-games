...
export default function FinishingAndScoringPage() {
  return (
    <Container className="py-10">
      ...
      <div className="grid items-start gap-x-6 gap-y-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,3fr)]">
        <LessonOutline items={finishingAndScoringOutline} />
        <div className="min-w-0">
          <FinishingAndScoringLesson />
          <LessonNavigation
            previousLesson={GO_LESSONS[2]}
            nextLesson={GO_LESSONS[4]}
          />
        </div>
      </div>
    </Container>
